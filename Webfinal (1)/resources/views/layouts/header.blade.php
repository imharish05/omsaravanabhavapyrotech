...
<header class="hdr" id="hdr">
    <div class="hdr-inner">
        ...
        <a href="{{ url('/') }}" class="hdr-logo">
            <img src="{{ str_replace('http://', '//', env('MAIN_URL', '/')) . $global_settings->logo }}" alt="OM Saravanabhava Pyrotech" id="hdrLogoImg">
        </a>
...
<div class="hdr-mobile" id="hdrMobile" aria-hidden="true">
    <div class="hdr-mobile-panel">
        <div class="hdr-mobile-top">
            <img src="{{ str_replace('http://', '//', env('MAIN_URL', '/')) . $global_settings->logo }}" alt="Logo" class="hdr-mobile-logo">
...
.hdr-ticker-track i { color: #e53a12; }
.hdr-topbar-phone {
    display: flex;
    align-items: center;
    gap: 7px;
...
.hdr-topbar-phone:hover { color: #e53a12; }
.hdr-topbar-phone i { color: #e53a12; }
...
.hdr-link:hover { background: #faf0ee; color: #e53a12; }
.hdr-link--active { color: #e53a12; background: #fdf3f1; }
...
.hdr-lang-btn:hover { border-color: #e53a12; background: #fdf3f1; color: #e53a12; }
...
.hdr-lang-opt:hover { background: #fdf3f1; color: #e53a12; }
...
.hdr-cta:hover { background: #c92a0d; transform: translateY(-1px); }
...
.hdr-burger:hover { border-color: #e53a12; }
.hdr-burger span {
    display: block;
    height: 2px;
    background: #333;
...
.hdr-mobile-close:hover { background: #fdf3f1; color: #e53a12; }
.hdr-mobile-nav {
    display: flex;
    flex-direction: column;
    padding: 16px 16px;
...
.hdr-mobile-link--active { background: #fdf3f1; color: #e53a12; }
.hdr-mobile-link:hover i,
.hdr-mobile-link--active i { color: #e53a12; }
.hdr-mobile-footer {
...
.hdr-mlang-btn:hover,
.hdr-mlang-btn.active { background: #e53a12; border-color: #e53a12; color: #fff; }
.hdr-mobile-cta {
    display: flex;
    align-items: center;
    justify-content: center;
...
.hdr-mobile-call i { color: #e53a12; }
.hdr-mobile-call:hover { border-color: #e53a12; color: #e53a12; }
