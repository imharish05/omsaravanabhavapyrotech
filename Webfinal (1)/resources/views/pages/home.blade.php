    ...
    <section class="hero-slider">
        ...
        <div class="slide {{ $index === 0 ? 'active' : '' }}">
            ...
            <div class="hero-badges">
                <div class="hero-badge-item"><i class="fa-solid fa-award"></i> Premium Quality</div>
                <div class="hero-badge-item"><i class="fa-solid fa-percent"></i> 80% Discount</div>
                <div class="hero-badge-item"><i class="fa-solid fa-star"></i> 5000+ Customers</div>
            </div>
            @else
            <div class="hero-btns">
    ...
    <div class="why-inner">
        ...
        <div class="why-stats">
            ...
            @for($i=0; $i<4; $i++)
                ...
                'number' => $rawStats[$i]['number'] ?? ($defaultStats[$i]['number'] ?? ''),
...
<section class="cta-banner">
    <div class="cta-banner-inner">
        ...
        <div class="cta-btn-group">
            ...
            <a href="https://wa.me/{{ $settings->cta_data['whatsapp'] ?: ($settings->whatsapp_number ?? '') }}" class="btn-outline"
                style="border-color:rgba(255,255,255,.3); color:#fff;">
