                ...
                <td style="padding: 20px 40px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 30px;">
                        <thead>
                            <tr>
                                <th
                                    style="text-align: left; padding: 15px 10px; font-size: 11px; color: #999; text-transform: uppercase; border-bottom: 1px solid #efebe1;">
                                    Product details</th>
                                <th
                                    style="text-align: right; padding: 15px 10px; font-size: 11px; color: #999; text-transform: uppercase; border-bottom: 1px solid #efebe1;">
                                    Price</th>
                                <th
                                    style="text-align: right; padding: 15px 10px; font-size: 11px; color: #999; text-transform: uppercase; border-bottom: 1px solid #efebe1;">
                                    Qty</th>
                        ...
                        <tbody>
                            @foreach($cartItems as $item)
                                <tr>
                                    <td style="padding: 15px 10px; border-bottom: 1px solid #f9f7f2;">
                                        <div style="font-size: 14px; font-weight: 700; color: #101010; margin-bottom: 3px;">
                                            {{ $item['product_name'] }}</div>
                                        <div style="font-size: 10px; color: #B8860B; font-weight: bold;">Fireworks Category
                                        </div>
                                    </td>
                                    <td
                                        style="padding: 15px 10px; text-align: right; font-size: 14px; color: #666; border-bottom: 1px solid #f9f7f2;">
                                        ₹{{ number_format($item['price'], 2) }}</td>
                                    <td
                                        style="padding: 15px 10px; text-align: right; font-size: 14px; color: #666; border-bottom: 1px solid #f9f7f2;">
                                        {{ $item['qty'] }}</td>
                                    <td
                                        style="padding: 15px 10px; text-align: right; font-size: 14px; font-weight: 800; color: #101010; border-bottom: 1px solid #f9f7f2;">
